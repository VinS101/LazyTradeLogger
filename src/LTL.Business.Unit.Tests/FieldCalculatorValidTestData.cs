...
namespace LTL.Business.Unit.Tests
{
    public class FieldCalculatorValidTestData : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return When.StrategyIsPutCreditSpread.ShouldCalculateExpectedFields;
        ...
        private static class When
        {
            ...
            public static class StrategyIsPutCreditSpread
            {
                public static object[] ShouldCalculateExpectedFields
                {
                    get
                    {
                        return new object[]
                        {
                            new TradeDataDto
                            {
                                ...
                                ShortPutStrike = 230,
                                LongPutStrike = 225,
                                CommentsAtOpen = "Put credit spread for MSFT!"
                            },
                            new TradeDataDto
                            {
                                Ticker = "MSFT",
                                ...
                                CommentsAtOpen = "Put credit spread for MSFT!",
                                TotalCredit = new decimal(172.00),
                                MaxRisk = new decimal(328.00),
                                DTE = 7, // Expiration date - DateTime.Now
                                RiskRewardRatio = new decimal(0.5244),
                                DaysInTrade = 0,
                                TradeStatus = TradeStatus.OPEN,
                                MaxProfit = new decimal(172.00),
                                ProbablityOfProfit = new decimal(65.6) // 100 - (((total credit)/width) * 100)
                            },
                        };
                    }
                }
